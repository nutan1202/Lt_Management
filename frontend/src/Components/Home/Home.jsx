...
function Home() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((resp) => {
        ...
        setLoading(false);
        // console.log(resp.data.approvedRequests)
      })
      .catch(function (err) {
        setLoading(false);
      });
  ...
  return (
    <div className="w-full h-screen overflow-hidden">
      <Navbar />
      <section className="p-2 pb-0 flex flex-col mb-auto items-center h-[80%] overflow-y-auto">
        <h2 className="mb-4 text-2xl font-bold leading-none tracking-tight text-gray-900 md:text-xl lg:text-3xl dark:text-white">
          Approved Lts
        </h2>
        {loading ? (
          <div role="status">
